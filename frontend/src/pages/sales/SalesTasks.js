...
const SalesTasks = () => {
  ...
  const isOverdue = (dueDate) => {
    return dueDate && dueDate.split('T')[0] < today;
  };

  return (
    <div className="animate-fadeIn" data-testid="sales-tasks-page">
      {/* Header */}
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="headline-sm mb-1" style={{ color: 'var(--on-surface)' }}>Tasks</h1>
      ...
      <div className="flex gap-2 mb-6">
        {[
          ...
          <button
            ...
            style={{ color: filter === tab.value ? 'var(--primary)' : 'var(--on-surface-variant)' }}
      ...
      <div className="card-widget">
        {loading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="body-md" style={{ color: 'var(--on-surface-variant)' }}>
              {filter === 'all' ? 'Create a task to get started' : `No ${filter} tasks`}
            </p>
          </div>
        ) : (
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={loading} data-testid="submit-task-btn">
