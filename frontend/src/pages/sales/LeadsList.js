...
/* ── Seed data ──────────────────────────────────────── */
const SEED = [
  { id:'1', full_name:'Priya Sharma',   email:'priya@infosys.com',   phone:'+91 98765 43210', company:'Infosys Ltd',  job_title:'CTO',           source:'Apollo',     status:'interested',       next_follow_up:'2026-04-01', notes:'Interested in AI Suite demo', created_at:'2026-03-25' },
  { id:'2', full_name:'Rahul Mehta',    email:'rahul@tcs.com',        phone:'+91 99887 76655', company:'TCS',          job_title:'VP Sales',      source:'CSV Import', status:'contacted',        next_follow_up:'2026-04-02', notes:'Sent initial deck', created_at:'2026-03-24' },
  { id:'3', full_name:'Anika Patel',    email:'anika@wipro.com',      phone:'+91 99112 23344', company:'Wipro',        job_title:'Director',      source:'Manual',     status:'called',           next_follow_up:'2026-04-02', notes:'Scheduled callback', created_at:'2026-03-23' },
  { id:'4', full_name:'Vikram Singh',   email:'vikram@hcl.com',       phone:'+91 97654 32109', company:'HCL Tech',     job_title:'CISO',          source:'Apollo',     status:'new',              next_follow_up:'2026-04-03', notes:'', created_at:'2026-03-22' },
  { id:'5', full_name:'Deepa Nair',     email:'deepa@mindtree.com',   phone:'+91 96543 21098', company:'Mindtree',     job_title:'Head of AI',    source:'LinkedIn',   status:'follow_up_needed', next_follow_up:'2026-03-28', notes:'Overdue — follow up ASAP', created_at:'2026-03-20' },
  { id:'6', full_name:'Arjun Kumar',    email:'arjun@tech9.in',       phone:'+91 95432 10987', company:'Tech Mahindra',job_title:'MD',            source:'Apollo',     status:'closed',           next_follow_up:'', notes:'Deal signed ✓', created_at:'2026-03-18' },
  { id:'7', full_name:'Sunita Reddy',   email:'sunita@oracle.com',    phone:'+91 94321 09876', company:'Oracle India', job_title:'EVP',           source:'Manual',     status:'rejected',         next_follow_up:'', notes:'Not interested at this time', created_at:'2026-03-15' },
  { id:'8', full_name:'Kiran Desai',    email:'kiran@ibm.com',        phone:'+91 93210 98765', company:'IBM India',    job_title:'CIO',           source:'CSV Import', status:'new',              next_follow_up:'2026-04-05', notes:'', created_at:'2026-03-14' },
  { id:'9', full_name:'Meera Joshi',    email:'meera@accenture.com',  phone:'+91 92109 87654', company:'Accenture',    job_title:'Head AI Labs', source:'Apollo',     status:'interested',       next_follow_up:'2026-04-01', notes:'Strong fit for enterprise tier', created_at:'2026-03-12' },
  { id:'10',full_name:'Rajesh Gupta',   email:'rajesh@capgemini.com', phone:'+91 91098 76543', company:'Capgemini',    job_title:'SVP',           source:'LinkedIn',   status:'contacted',        next_follow_up:'2026-04-04', notes:'Met at AI summit', created_at:'2026-03-10' },
];
...
const AddLeadModal = ({ onClose, onAdd }) => {
  ...
  const submit = () => {
    ...
    onAdd({ ...form, id: String(Date.now()), created_at: new Date().toISOString().slice(0,10) });
    onClose();
  };
...
export default function LeadsList() {
  ...
  const overdue = leads.filter(l => l.next_follow_up && l.next_follow_up < '2026-04-01' && !['closed','completed','rejected','lost'].includes(l.status)).length;
        ...
        <div style={{ overflowX:'auto' }}>
          <table className="data-table" style={{ margin:0 }}>
            ...
            <tbody>
              ...
              {paged.map(lead => {
                const isOver = lead.next_follow_up && lead.next_follow_up < '2026-04-01' && !['closed','completed','rejected','lost'].includes(lead.status);
